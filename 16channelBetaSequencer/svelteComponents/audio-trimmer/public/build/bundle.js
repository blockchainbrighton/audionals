...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 254, 2, 7494);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Enter Ordinal ID");
    			add_location(input0, file$1, 255, 2, 7519);
    			add_location(button0, file$1, 256, 2, 7597);
    			attr_dev(canvas0, "width", "4000");
    			attr_dev(canvas0, "height", "800");
    			attr_dev(canvas0, "class", "waveform-canvas svelte-ghp5vi");
    			add_location(canvas0, file$1, 259, 4, 7733);
    			attr_dev(canvas1, "width", "4000");
    			attr_dev(canvas1, "height", "800");
    			attr_dev(canvas1, "class", "playback-canvas svelte-ghp5vi");
    			add_location(canvas1, file$1, 260, 4, 7824);
    			attr_dev(div0, "class", "dimmed svelte-ghp5vi");
    			set_style(div0, "width", /*startDimmedWidth*/ ctx[4]);
    			set_style(div0, "left", "0");
    			add_location(div0, file$1, 261, 4, 7923);
    			attr_dev(div1, "class", "dimmed svelte-ghp5vi");
    			set_style(div1, "width", /*endDimmedWidth*/ ctx[5]);
    			set_style(div1, "right", "0");
    			set_style(div1, "left", "auto");
    			add_location(div1, file$1, 262, 4, 7998);
    			attr_dev(div2, "class", "waveform-container svelte-ghp5vi");
    			add_location(div2, file$1, 257, 2, 7650);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "class", "slider svelte-ghp5vi");
    			attr_dev(input1, "min", "0");
    			attr_dev(input1, "max", /*maxDuration*/ ctx[0]);
    			attr_dev(input1, "step", "0.01");
    			add_location(input1, file$1, 265, 0, 8088);
    			attr_dev(input2, "type", "range");
    			attr_dev(input2, "class", "slider svelte-ghp5vi");
    			attr_dev(input2, "min", "0");
    			attr_dev(input2, "max", /*maxDuration*/ ctx[0]);
    			attr_dev(input2, "step", "0.01");
    			add_location(input2, file$1, 266, 0, 8194);
    			add_location(button1, file$1, 268, 0, 8299);
    			add_location(button2, file$1, 269, 0, 8342);
    			attr_dev(button3, "class", "loop-button svelte-ghp5vi");
    			toggle_class(button3, "off", !/*loopState*/ ctx[10]);
    			toggle_class(button3, "on", /*loopState*/ ctx[10]);
    			add_location(button3, file$1, 271, 0, 8459);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			/*canvas0_binding*/ ctx[17](canvas0);
    			append_dev(div2, t5);
    			append_dev(div2, canvas1);
    			/*canvas1_binding*/ ctx[18](canvas1);
    			append_dev(div2, t6);
    		...
    		d: function destroy(detaching) {
    			...
    			/*canvas0_binding*/ ctx[17](null);
    			/*canvas1_binding*/ ctx[18](null);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	// Add a new writable store for loop control
    	const loopEnabled = writable(false);

    	let loopState = false; // This will hold the current state of the loop
    	let isLooping = false;
    	...
    	async function fetchAudio(ordinalId) {
    		...
    		try {
    			...
    			if (contentType && contentType.includes('application/json')) {
    				...
    				$$invalidate(15, audioBuffer = await decodeAudioData(arrayBuffer)); // Using your custom decodeAudioData function
    			} else {
    	...
    	// Call this function to toggle the loop on or off
    	function toggleLoop() {
    		isLooping = !isLooping; // Toggle the loop state
    	} // Add code to change the button color based on isLooping
    	...
    	function playAudio() {
    		...
    		// When the buffer has finished playing, check if looping is enabled
    		sourceNode.onended = () => {
    			if (isLooping) {
    				// Restart the audio automatically if looping
    				playAudio();
    			} else {
    				isPlaying = false;
    			}
    	...
    	// Call this function when the stop button is clicked
    	function stopAudio() {
    		if (isPlaying && sourceNode) {
    			...
    			// Reset the loop state if needed
    			isLooping = false;
    		}
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('audioBuffer' in $$props) $$invalidate(15, audioBuffer = $$props.audioBuffer);
    		...
    		if ('loopState' in $$props) $$invalidate(10, loopState = $$props.loopState);
    		if ('isLooping' in $$props) isLooping = $$props.isLooping;
    		if ('canvas' in $$props) $$invalidate(6, canvas = $$props.canvas);
    		if ('playbackCanvas' in $$props) $$invalidate(7, playbackCanvas = $$props.playbackCanvas);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*audioBuffer, $startSliderValue, maxDuration, $endSliderValue*/ 32775) {
    			{
    				$$invalidate(0, maxDuration = audioBuffer ? audioBuffer.duration : 0);

    				$$invalidate(4, startDimmedWidth = audioBuffer
    				? `${$startSliderValue / maxDuration * 100}%`
    				: '0%');

    				$$invalidate(5, endDimmedWidth = audioBuffer
    				? `${(1 - $endSliderValue / maxDuration) * 100}%`
    				: '0%');
    		...
    		if ($$self.$$.dirty[0] & /*audioBuffer, $startSliderValue, $endSliderValue*/ 32774) {
    			if (audioBuffer) {
    				$$invalidate(4, startDimmedWidth = `${$startSliderValue / audioBuffer.duration * 100}%`);
    				$$invalidate(5, endDimmedWidth = `${(1 - $endSliderValue / audioBuffer.duration) * 100}%`);
    			} else {
    				$$invalidate(4, startDimmedWidth = '0%');
    				$$invalidate(5, endDimmedWidth = '0%');
    			}
    		}

    		if ($$self.$$.dirty[0] & /*$startSliderValue, $endSliderValue*/ 6) {
    			{
    				if ($startSliderValue >= $endSliderValue) {
    					startSliderValue.set($endSliderValue - 0.01);
    				}
