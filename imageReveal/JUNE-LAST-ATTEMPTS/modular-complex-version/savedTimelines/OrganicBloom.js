...
{ effect: "blur", param: "radius", from: 25, to: 15, startBar: 0, endBar: 16, easing: "linear" },
...
{ effect: "filmGrain", param: "intensity", from: 0.5, to: 0.8, startBar: 0, endBar: 16, easing: "linear" }, // Grain increases

// --- Phase 2: Hue Sweep & Sharpening (16-32 bars) ---
{ effect: "fade", param: "progress", from: 0.6, to: 0.85, startBar: 16, endBar: 32, easing: "easeInOut" },
...
{ effect: "colourSweep", param: "progress", from: 0, to: 0.7, startBar: 16, endBar: 32, hueRange: [0, 90], edgeSoftness: 0.7, color: [255,220,200,0.1] },
