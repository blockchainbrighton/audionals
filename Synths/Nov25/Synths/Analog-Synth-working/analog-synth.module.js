...
export default class AnalogSynth {
    constructor(toneInstance, midiManager) {
        ...
        // Init audio immediately upon construction (or via explicit init method)
        this.initSynth();
    }
    ...
    // Audio init moved out of mount
    initSynth() {
        if(this.state.synth) return; // Already inited
        const T = this.Tone;
        // ... (rest of audio graph creation) ...
