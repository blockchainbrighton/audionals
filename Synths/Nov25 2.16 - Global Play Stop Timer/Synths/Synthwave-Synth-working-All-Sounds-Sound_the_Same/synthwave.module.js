...
export default class SynthwaveSynth {
    ...
    injectStyles() {
        ...
        .sw-wrapper {
            ...
            --knob-size: 35px; --key-white: #e0e0e0; --key-black: #111;
        ...
        #synth-ui {
            ...
            border-radius: 12px; padding: 10px; z-index: 10; backdrop-filter: blur(5px);
            display: flex; flex-direction: column; gap: 5px;
        }
        header { display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--neon-cyan); padding-bottom: 5px; }
        h1 { font-size: 18px; margin: 0; text-shadow: 2px 2px 0px var(--neon-pink); letter-spacing: 4px; font-style: italic; }
        .patch-display { background: #000; border: 1px solid var(--neon-cyan); color: var(--neon-pink); padding: 2px 10px; font-size: 14px; font-weight: bold; text-shadow: 0 0 5px var(--neon-pink); text-align: center; }
        .controls-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 5px; }
        .module { border: 1px solid rgba(0, 255, 255, 0.3); border-radius: 6px; padding: 5px; background: rgba(0, 0, 0, 0.3); position: relative; }
        .module-title { position: absolute; top: -8px; left: 5px; background: var(--bg-dark); padding: 0 3px; font-size: 9px; color: #888; text-transform: uppercase; }
        .knob-row { display: flex; flex-wrap: wrap; justify-content: space-around; margin-top: 5px; }
        .knob-container { display: flex; flex-direction: column; align-items: center; margin: 2px; }
        .knob {
        ...
        .label { font-size: 8px; margin-top: 2px; color: #aaa; }
        .knob-val { font-size: 8px; color: var(--neon-cyan); margin-top: 1px; }
        .wave-select { width: 100%; background: #000; color: var(--neon-cyan); border: 1px solid #444; margin-bottom: 5px; font-family: inherit; font-size: 10px; }
        .btn-toggle { background: #222; border: 1px solid #444; color: #666; padding: 2px 6px; cursor: pointer; font-size: 9px; width: 100%; margin-top: 3px; transition: all 0.2s; }
        .btn-toggle.active { background: var(--neon-pink); color: #fff; border-color: var(--neon-pink); box-shadow: 0 0 10px var(--neon-pink); }
        .preset-strip { grid-column: span 4; display: flex; gap: 3px; background: rgba(0,0,0,0.5); padding: 3px; overflow-x: auto; }
        .preset-btn { background: #111; border: 1px solid var(--neon-cyan); color: var(--neon-cyan); padding: 2px 6px; cursor: pointer; font-family: inherit; font-size: 10px; white-space: nowrap; }
        .preset-btn.active { background: var(--neon-cyan); color: #000; }
        #keyboard { margin-top: 5px; background: #111; border-top: 2px solid var(--neon-pink); }
        `;
