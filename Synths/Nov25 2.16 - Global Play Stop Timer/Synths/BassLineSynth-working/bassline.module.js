...
export default class BassLineSynth {
    ...
    injectStyles() {
        ...
        .header {
            ...
            margin-bottom: 5px; border-bottom: 1px solid #444; padding-bottom: 5px;
        }
        .logo { font-weight: bold; font-size: 1.2rem; color: var(--text-color); }
        .logo span { color: var(--accent-color); }
        .top-controls { display: flex; gap: 10px; align-items: center; }
        select { background: #333; color: #fff; border: 1px solid #555; padding: 2px; border-radius: 4px; font-size: 0.7rem; }
        #oscilloscope { width: 100px; height: 35px; background: #000; border: 1px solid #555; border-radius: 4px; }
        .controls-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(100px, 1fr)); gap: 5px; margin-bottom: 10px; }
        .control-group { border: 1px solid #444; padding: 5px; border-radius: 4px; background: #2a2a2a; }
        .group-title { font-size: 0.7rem; color: #888; margin-bottom: 5px; text-transform: uppercase; border-bottom: 1px solid #333; padding-bottom: 2px; }
        .knob-wrapper { display: flex; flex-direction: column; align-items: center; margin-bottom: 5px; }
        .knob {
        ...
        .knob-label { font-size: 0.6rem; margin-top: 2px; color: #aaa; }
        .knob-value { font-size: 0.6rem; color: var(--highlight); height: 10px; }
        .sequencer-section { background: #222; padding: 5px; border-radius: 4px; border: 1px solid #444; }
        .seq-grid { display: grid; grid-template-columns: repeat(16, 1fr); gap: 1px; }
        .step-col { display: flex; flex-direction: column; align-items: center; gap: 2px; }
        .led { width: 6px; height: 6px; background: var(--led-off); border-radius: 50%; margin-bottom: 2px; border: 1px solid #000; }
        .led.active { background: var(--led-on); box-shadow: 0 0 5px var(--led-on); }
        .led.current { background: #ffff00; box-shadow: 0 0 8px #ffff00; }
        .seq-btn {
            width: 100%; height: 16px; border: 1px solid #444; background: #333;
            cursor: pointer; font-size: 0.5rem; display: flex; justify-content: center; align-items: center; color: #888;
        }
        ...
        .note-select { width: 100%; font-size: 0.5rem; background: #111; color: #ccc; border: 1px solid #333; -webkit-appearance: none; padding: 0; text-align: center; }
        .transport-controls { display: flex; gap: 10px; margin-top: 5px; align-items: center; }
        .btn-main { background: #444; color: #fff; border: none; padding: 2px 10px; border-radius: 4px; cursor: pointer; font-weight: bold; font-size: 0.7rem; }
        .btn-main:hover { background: #555; }
        .btn-main.playing { background: #0f0; color: #000; }
        #keyboard { margin-top: 5px; background: #111; border-top: 2px solid #444; }
        `;
