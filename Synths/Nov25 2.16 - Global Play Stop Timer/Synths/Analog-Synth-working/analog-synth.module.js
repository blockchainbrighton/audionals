...
export default class AnalogSynth {
    ...
    injectStyles() {
        ...
        .header {
            font-size: 0.6rem; color: #888; border-bottom: 1px solid #444;
            margin-bottom: 5px; padding-bottom: 2px; text-transform: uppercase;
            letter-spacing: 1px; display: flex; justify-content: space-between;
        }
        .row { display: flex; justify-content: space-around; align-items: flex-end; gap: 2px; flex: 1; }
        .ctrl { display: flex; flex-direction: column; align-items: center; width: 40px; }
        .ctrl label { font-size: 0.5rem; margin-top: 2px; color: #aaa; text-align: center; }
        
        .knob-wrap { width: 35px; height: 35px; position: relative; }
        .knob {
        ...
        input[type="range"].v-slider {
            -webkit-appearance: slider-vertical; width: 8px; height: 50px; background: transparent;
        }
        select {
            background: #111; color: var(--accent); border: 1px solid #444;
            font-size: 0.6rem; width: 100%; margin-bottom: 2px;
        }
        canvas#scope { width: 100%; height: 40px; background: #000; border: 1px solid #444; }
        #preset-list { display: flex; gap: 5px; overflow-x: auto; padding-bottom: 5px; }
        .p-btn {
            background: #333; border: 1px solid #555; color: #ccc;
            padding: 2px 6px; font-family: inherit; font-size: 0.6rem;
