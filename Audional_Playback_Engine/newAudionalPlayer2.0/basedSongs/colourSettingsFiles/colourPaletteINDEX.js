...
window.colorPalette = {
    ...
    primary: [
        ...
        { hex: "#00BFFF", index: 18 }, // color-deepskyblue
        { hex: "#4B0082", index: 19 }, // color-indigo
        { hex: "#FF1493", index: 20 }, // color-deeppink
        { hex: "#FFFFFF", index: 21 }, // color-white
        { hex: "#C0C0C0", index: 22 }, // color-silver
        { hex: "#FFD700", index: 23 }, // color-gold (different shade or to ensure it covers vibrant orange too)
