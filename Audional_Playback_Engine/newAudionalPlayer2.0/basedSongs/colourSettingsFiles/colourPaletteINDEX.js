...
window.colorPalette = {
    ...
    primary: [
        ...
        { hex: "#FFD700", index: 20 }, // color-gold (different shade or to ensure it covers vibrant orange too)
        { hex: "#FFFFFF", index: 21 }, // color-white
        { hex: "#00BFFF", index: 22 }, // color-deepskyblue
        { hex: "#FF1493", index: 23 },  // color-deeppink
    ],
    secondary: [
        { hex: "#000000", index: 1 },  // color-black
        { hex: "#8000FF", index: 2 },  // color-purple
