...
function renderInstrumentControls(targetContainer, channelData, chIndex) {
    ...
    instrumentControls.appendChild(activateBtn);
    ...
    instrumentControls.appendChild(recordBtn);
...
export function render() {
    ...
    currentSeq.channels.forEach((channelData, chIndex) => {
        ...
        const detailsVisible = channelData.type === 'sampler'
            ? isChannelDetailsVisible(sequenceIndex, chIndex)
            : true;
        if (channelData.type === 'sampler') {
        ...
        if (channelData.type === 'sampler') {
            ...
            layoutToggle.textContent = detailsVisible ? 'Steps only' : 'Full controls';
        ...
        if (channelData.type === 'sampler') {
            if (detailsVisible) {
                ...
                controlsRow.append(
                    mixControls,
                    typeControlsContainer,
                    insertControls,
                    createChannelWaveform(channelData)
                );
                channelEl.appendChild(controlsRow);
            } else {
