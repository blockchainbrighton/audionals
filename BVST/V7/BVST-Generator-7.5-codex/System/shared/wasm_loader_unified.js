...
export class BvstSynth {
    ...
    free() {
        // Free any scratch buffers we allocated for audio processing.
        // (Not strictly required, but avoids unbounded WASM memory growth if synths are reloaded.)
    ...
    process(in_l, in_r, output_l, output_r) {
        ...
        // Allocate scratch buffers once (AudioWorklet render quantum is typically 128).
