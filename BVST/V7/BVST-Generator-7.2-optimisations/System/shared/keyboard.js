...
export class Keyboard {
    ...
    _handleNoteOn(midi, velocity = 1.0) {
        ...
        // If the callback expects standard MIDI velocity (0-127), we might need to scale.
        // But the mtof/freq callback usually just takes freq.
        // Let's pass normalized velocity (0-1) as a 3rd arg if supported?
        // The constructor callback signature is `onNoteOn(midi, freq)`.
        // Let's change it to `onNoteOn(midi, freq, velocity)`.
