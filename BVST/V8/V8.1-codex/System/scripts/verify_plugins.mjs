...
async function main() {
  const pluginDirs = [
    'Plugins/Dynamics/PrimarySourceEnhancer',
    'Plugins/Dynamics/UniversalDynamics',
    'Plugins/Effects/UniversalFX',
    'Plugins/Instruments/UniversalSynth',
    'Plugins/Modulation/UniversalMod',
    'Plugins/Utility/UniversalUtility'
  ];
