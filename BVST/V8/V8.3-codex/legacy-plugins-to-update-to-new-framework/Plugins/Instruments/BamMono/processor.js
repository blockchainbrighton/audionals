...
class BvstProcessor extends AudioWorkletProcessor {
    ...
    async handleMessage(event) {
        if (event.data.type === 'INIT_WASM') {
            ...
            // Check if the synth supports sample loading (some synths/samplers do)
            // Note: Shared BvstSynth might not expose load_sample if it wasn't in the generic export.
            // If specific plugins need this, the shared loader might need extension.
