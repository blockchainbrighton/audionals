...
*   **Actions:**
    ...
    *   Outputs UI artifacts to `Plugins/<Category>/<PluginName>/dist/vX.X.X/` (worklet + WASM stay in `System/shared/`).
...
1.  **`System/unified_audio_engine/src/lib.rs`**: Add DSP/models and route by plugin ID/name.
