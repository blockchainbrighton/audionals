...
export class BvstSynth {
    ...
    /**
     * @param {Float32Array} _in_l
     * @param {Float32Array} _in_r
     * @param {Float32Array} output_l
     * @param {Float32Array} output_r
     */
    process(_in_l, _in_r, output_l, output_r) {
        const ptr0 = passArrayF32ToWasm0(_in_l, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF32ToWasm0(_in_r, wasm.__wbindgen_export);
