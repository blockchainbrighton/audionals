import init, { BvstSynth } from "../../../System/shared/wasm_loader_v2.js";

// --- BVST AudioWorkletProcessor ---
// Universal Thin Plugin Processor
...
class BvstProcessor extends AudioWorkletProcessor {
    constructor() {
        ...
        console.log("BVST: Universal Processor constructed.");
    }
    ...
    async handleMessage(event) {
        if (event.data.type === 'INIT_WASM') {
            ...
            try {
                ...
                console.log("BVST: Engine instantiated.");
