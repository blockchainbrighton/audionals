// System/shared/wasm_loader_v2.js
// Universal Thin Plugin Loader (4-channel: Stereo In / Stereo Out)
...
export class BvstSynth {
    ...
    // --- UNIVERSAL V2 METHODS ---

    /**
     * @returns {string}
     */
    static get_descriptor() {
        const malloc = wasm.__wbindgen_export || wasm.__wbindgen_export2; // Try both
        const free = wasm.__wbindgen_export; 
        if(!malloc) throw new Error("Wasm malloc not found");
    ...
    // Universal Process: (InL, InR, OutL, OutR)
    process(input_l, input_r, output_l, output_r) {
        const malloc = wasm.__wbindgen_export || wasm.__wbindgen_export2;
        const ptr0 = passArrayF32ToWasm0(input_l, malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF32ToWasm0(input_r, malloc);
