...
export class BvstSynth {
    ...
    /**
     * @param {Float32Array} _input_l
     * @param {Float32Array} _input_r
     * @param {Float32Array} output_l
     * @param {Float32Array} output_r
     */
    process(_input_l, _input_r, output_l, output_r) {
        const ptr0 = passArrayF32ToWasm0(_input_l, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF32ToWasm0(_input_r, wasm.__wbindgen_export);
