# BVST-Template-5.0 (Blockchain Virtual Studio Tools)

## Project Overview

This directory contains **BVST-Template-5.0**, a comprehensive template for building browser-based audio plugins—**Blockchain Virtual Studio Tools (BVST)**—using **Rust** and **WebAssembly**. 

It has been upgraded to a **Universal Plugin Architecture**, supporting:
*   **Instruments:** Synthesizers, Samplers.
*   **Effects (FX):** Delays, Reverbs, Distortions, Compressors.
...
*   **Multi-Plugin Workspace:** Manage unlimited independent plugin projects in the `Synths/` directory.
...
See the `AI_SYNTH_GENERATION_GUIDE.md` for detailed instructions on generating new plugins using AI assistants or manually.
