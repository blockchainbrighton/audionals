// System/shared/wasm_loader_fx.js
// Shared WASM Loader for Effects & Hybrid Plugins (4-arg Process, Input/Output)
...
export class BvstSynth {
    ...
    // --- HYBRID / FX SPECIFIC ---
    // UniversalEngine has note_on, FX don't.
    // We include it here. If WASM doesn't export it, calling it will fail.
    // JS wrapper usually includes it if generated from UniversalEngine.
    ...
    // Process with 4 args (Input L, Input R, Output L, Output R)
    process(input_l, input_r, output_l, output_r) {
        const ptr0 = passArrayF32ToWasm0(input_l, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF32ToWasm0(input_r, wasm.__wbindgen_export);
