...
class ModeDApp extends HTMLElement {
  constructor() {
    super();
  ...
  connectedCallback() {
    ...
    wrapper.id = 'wrapper';
    this._canvas = document.createElement('mode-d-canvas');
    wrapper.appendChild(this._canvas);
    this._controls = document.createElement('mode-d-controls');
...
customElements.define('mode-d-app', ModeDApp);