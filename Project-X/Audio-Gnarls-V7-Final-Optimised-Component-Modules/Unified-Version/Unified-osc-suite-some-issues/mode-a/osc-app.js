...
class ModeAApp extends HTMLElement {
  constructor() {
    super();
  ...
  connectedCallback() {
    ...
    this._canvas = document.createElement('mode-a-canvas');
    this._controls = document.createElement('mode-a-controls');
...
customElements.define('mode-a-app', ModeAApp);