...
class ModeCApp extends HTMLElement {
  constructor() {
    super();
...
<ol>
  ...
  <li><b>Toggle Audio:</b> Click the image or use <b>Start Audio</b> button to start/stop.</li>
    ...
    this._canvas = document.createElement('mode-c-canvas');
    canvasContainer.appendChild(this._canvas);
    // Control panel
    this._controls = document.createElement('mode-c-controls');
...
customElements.define('mode-c-app', ModeCApp);