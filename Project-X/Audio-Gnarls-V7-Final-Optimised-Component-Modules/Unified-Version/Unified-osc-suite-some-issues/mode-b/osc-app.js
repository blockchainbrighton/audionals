...
class ModeBApp extends HTMLElement {
  constructor() {
    super();
  ...
  _render() {
    ...
    this.scopeCanvas = document.createElement('mode-b-canvas');
    this.controls = document.createElement('mode-b-controls');
...
customElements.define('mode-b-app', ModeBApp);