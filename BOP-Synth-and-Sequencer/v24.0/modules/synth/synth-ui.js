...
import PresetSelector from './synth-presets-ui.js';


const statefulModules = ['pianoRoll', 'enhancedControls', 'loopUI', 'presetSelector'];
...
export class BopSynthUI {
    ...
    init() {
        ...
        this.modules.presetSelector = ensureUIStateContract(ensureDestroy(new PresetSelector(
            this.uiElements.presets, this.eventBus
        )));
