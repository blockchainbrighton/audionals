...
export class EnhancedControls {
    ...
    setupEventListeners() {
        ...
        this.eventBus.addEventListener('preset-loaded', e => {
            const { preset, applyToEngine = false } = e.detail || {};
            if (preset) this.loadPreset(preset, { applyToEngine });
        });
    }
