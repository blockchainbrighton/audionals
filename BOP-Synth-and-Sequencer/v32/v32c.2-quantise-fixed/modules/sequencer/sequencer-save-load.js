                    ...
                    channels: seq.channels.map((chan, chanIndex) => {
                        ...
                        if (chan.type === 'sampler') {
                            ...
                            newChan.instrumentClip = chan.instrumentClip
                                ? JSON.parse(JSON.stringify(chan.instrumentClip))
                                : null;
                            newChan.instrumentId = chan.instrumentId;
                            newChan.instrumentType = chan.instrumentType || null;
                            newChan.pendingInstrumentType = chan.pendingInstrumentType || chan.instrumentType || null;
                        }
                        return newChan;
                    })
                };
