// Sequencer boot entry point
import { TONE_ORDINALS_URL } from './sequencer-config.js';
import { runtimeState, initializeProject, defaultSampleOrder, markSampleRecentlyUsed } from './sequencer-state.js';
...
async function loadTone(globalWindow, toneLoader) {
    const loaderFn = typeof toneLoader === 'function'
        ? toneLoader
        : () => import(/* @vite-ignore */ TONE_ORDINALS_URL);
