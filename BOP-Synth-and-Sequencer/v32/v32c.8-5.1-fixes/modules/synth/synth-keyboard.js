/**
 * @file Keyboard.js
 * @description Virtual keyboard UI component shared by sequencer instruments.
 */
...
export class Keyboard {
    ...
    addKeyHandlers(el, note) {
        ...
        if (pointerSupported) {
            el.onpointerdown = e => { e.preventDefault(); play(); };
            el.onpointerup = e => { e.preventDefault(); release(); };
