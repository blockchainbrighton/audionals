...
export function createInstrumentForChannel(seqIndex, chanIndex) {
    ...
    try {
        ...
        const logicOptions = { hostMode: 'sequencer', instrumentType };
        const logic = instrumentDefinition.createLogic(runtimeState.Tone, logicOptions);
        ...
        runtimeState.instrumentRack[instrumentId] = {
            ...
            logic: logic,
            lastWarmupTime: 0,
            isSequencerEmbed: !!logic?.isSequencerEmbed,
