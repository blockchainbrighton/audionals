...
import { projectState, runtimeState, initializeProject, syncNextInstrumentIdAfterLoad, ensureChannelMixDefaults, ensureSamplerChannelDefaults } from './sequencer-state.js';
                ...
                return {
                    channels: seq.channels.map((chan, chanIndex) => {
                        ...
                        if (chan.type === 'sampler') {
                            ...
                            const { sampleRegion, samplePlaybackRate, sampleFadeIn, sampleFadeOut } = chan;
    ...
    try {
        ...
        projectState.sequences.forEach(seq => {
            ...
            seq.channels.forEach(chan => {
                ...
                if (chan.type === 'sampler') ensureSamplerChannelDefaults(chan);
