...
auiTemplate.innerHTML = `
    <style>
        ...
        .control-column-inner .loop-controls {
            flex-shrink: 0;
        }
        ...
        .preset-random-btn:hover,
        .preset-random-btn:focus {
            background: var(--accent2);
            color: #0a0a0f;
            box-shadow: 0 0 12px var(--accent2)55;
            transform: translateY(-1px);
            outline: none;
        }

        .preset-random-btn:active {
    ...
    <div class="app-shell">
        ...
        <main class="workspace" aria-label="Synth workspace">
            <section class="workspace-top" aria-label="Transport controls">
                <div class="transport-controls" id="transport-controls"></div>
            </section>

            <div class="workspace-columns">
                <aside class="control-column" aria-label="Sound design controls">
                    <div class="control-column-inner">
                        <div class="preset-controls" id="preset-controls">
                            <div class="preset-header">
                                <label for="presetSelect">Preset Bank</label>
                                <span class="preset-current" data-role="preset-label">Custom</span>
                            </div>
                            <div class="preset-actions">
                                <select id="presetSelect" data-role="preset-select"></select>
                                <button type="button" class="preset-random-btn" data-role="preset-random">Randomise</button>
                            </div>
                        </div>
                ...
                <section class="playback-column" aria-label="Performance and sequencing">
                    <div class="playback-stack">
                        ...
                        <div class="midi-panel" aria-label="MIDI editor">
                            <h3 class="panel-title">Piano Roll Editor</h3>
...
export class BopSynthUIComponent extends HTMLElement {
    ...
    connect(logicController) {
        ...
        this.uiController = new BopSynthUI(logicController, {
            ...
            presets: this.shadowRoot.querySelector('#preset-controls')
        });
    }
