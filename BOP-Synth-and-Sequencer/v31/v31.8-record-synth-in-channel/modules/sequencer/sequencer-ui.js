...
import { projectState, runtimeState, getCurrentSequence, createNewChannel, initializeProject, ensureSamplerChannelDefaults, samplerChannelDefaults, createSequenceFromTemplate, ensureChannelInsertSettings, markSampleRecentlyUsed, pruneInactiveSampleCaches } from './sequencer-state.js';
...
function renderInstrumentControls(targetContainer, channelData, chIndex) {
    ...
    openBtn.textContent = 'View Synth';
