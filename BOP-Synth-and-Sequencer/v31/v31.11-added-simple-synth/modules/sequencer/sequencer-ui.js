    ...
    currentSeq.channels.forEach((channelData, chIndex) => {
        ...
        if (channelData.type === 'sampler') {
            if (detailsVisible) {
                ...
                controlsRow.append(mixControls, typeControlsContainer, insertControls, createChannelWaveform(channelData));
            ...
            const controlsRow = document.createElement('div');
            controlsRow.className = 'channel-controls-row';
            controlsRow.append(mixControls, typeControlsContainer, insertControls);
