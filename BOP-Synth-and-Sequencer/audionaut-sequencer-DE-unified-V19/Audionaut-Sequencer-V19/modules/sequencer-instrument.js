...
/**
 * Stubbed-out UI opener—left in place so callers don’t break.
 */
export async function openSynthUI() {
    console.warn('[INSTRUMENT-LITE] openSynthUI() is unavailable in the lite build.');
}
