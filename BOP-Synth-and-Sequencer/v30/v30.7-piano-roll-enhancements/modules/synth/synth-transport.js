...
export class Transport {
    constructor(containerElement, eventBus, statusElements = {}) {
    ...
    updateGlobalStatus(isRecording, isArmed, isPlaying, hasSequence) {
        ...
        const recStatEl = this.statusElements?.recordStatus || null;
        const recIndEl = this.statusElements?.recordIndicator || null;
