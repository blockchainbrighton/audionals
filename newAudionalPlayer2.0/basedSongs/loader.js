...
fetch(window.jsonDataUrl)
    ...
    .then(data => {
        ...
        // Log specific parts of the JSON data for comparison
        console.log("Project Name:", data.projectName);
        console.log("Artist Name:", data.artistName);
        console.log("Project BPM:", data.projectBPM);
        console.log("Current Sequence:", data.currentSequence);
        console.log("Channel URLs:", data.channelURLs);
        console.log("Project Sequences:", data.projectSequences);
