...
const server = http.createServer(async (req, res) => {
  ...
  if (pathname === '/api/estimate' && req.method === 'POST') {
    try {
      ...
      // In future, we could refine this based on 'model' to detect billable characters more accurately.
  ...
  if (pathname === '/api/projects' && req.method === 'POST') {
    ...
    req.on('end', async () => {
      try {
        ...
        const titleIntroText = typeof data.titleIntroText === 'string'
...
${MODEL_SELECT_OPTIONS_HTML}
        ...
        <div class="form-group">
          <label for="title-intro-script">Title Intro Script</label>
          <textarea id="title-intro-script" placeholder="e.g., “This is <Title> by <Authors>, narrated by …”"></textarea>
        </div>
  ...
  <script>
    ...
    async function estimateCost() {
      ...
      try {
        ...
        // Rough estimate: 1 char = 1 credit (standard). Turbo is 0.5.
        // Just showing character count is safest.
        display.textContent = \`\${result.count.toLocaleString()} characters (~ \${result.count.toLocaleString()} credits)\`;
      } catch (error) {
    ...
    document.getElementById('new-book-form').addEventListener('submit', async (e) => {
      ...
      const data = {
        ...
        titleIntroText: document.getElementById('title-intro-script').value,
