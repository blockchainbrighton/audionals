            ...
            <div class="chapter-header">
                ...
                <div class="ch-row" style="margin-top:6px;">
                    ...
                    <div style="display:flex;gap:5px;">
                        ${ch.audioUrl ? `<button class="sm-btn ${playing?'playing':''}" onclick="playChapter(${idx},event)">${playing?'⏹':'▶'}</button>` : ''}
            ...
            <div class="project-item">
                ...
                <div class="project-actions">
                    ...
                    ${x.type!=='ghost' ? `
                        ...
                        <button class="sm-btn danger" onclick="deleteProject('${x.id}', event)" title="Delete Project">🗑</button>
                    ` : ''}
                </div>
