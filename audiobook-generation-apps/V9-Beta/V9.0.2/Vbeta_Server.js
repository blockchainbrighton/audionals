                    ...
                    data.chapters.forEach((ch, idx) => {
                        ...
                        if (ch.chunks && Array.isArray(ch.chunks)) {
                            ch.chunks.forEach((chunk, cIdx) => {
                                // If already has audioUrl and it works, skip? No, better verify.
                                // Pattern: projectId_ch{idx}_chk{cIdx}_hash.mp3
