...
impl AudioNode for Pan_LinNode {
...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = Pan_LinNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "Pan_Lin");
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = Pan_LinNode::new();
