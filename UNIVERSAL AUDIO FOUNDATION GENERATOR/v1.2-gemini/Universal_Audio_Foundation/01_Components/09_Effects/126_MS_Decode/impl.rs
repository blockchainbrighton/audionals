...
impl AudioNode for MS_DecodeNode {
...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = MS_DecodeNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "MS_Decode");
    ...
    fn test_determinism() {
        ...
        let mut node = MS_DecodeNode::new();
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = MS_DecodeNode::new();
