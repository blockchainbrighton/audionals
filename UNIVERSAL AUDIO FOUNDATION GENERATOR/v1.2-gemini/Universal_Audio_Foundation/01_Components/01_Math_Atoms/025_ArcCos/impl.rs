...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = ArcCosNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "ArcCos");
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = ArcCosNode::new();
