...
pub struct BufferWrite_RawNode {
    // TODO: Add internal state here
}

impl BufferWrite_RawNode {
    pub fn new() -> Self {
        Self {}
    }
}

impl AudioNode for BufferWrite_RawNode {
...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = BufferWrite_RawNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "BufferWrite_Raw");
    ...
    fn test_determinism() {
        ...
        let mut node = BufferWrite_RawNode::new();
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = BufferWrite_RawNode::new();
