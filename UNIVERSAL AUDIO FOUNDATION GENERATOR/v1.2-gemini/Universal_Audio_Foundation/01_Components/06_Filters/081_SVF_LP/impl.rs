...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = SVF_LPNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "SVF_LP");
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = SVF_LPNode::new();
