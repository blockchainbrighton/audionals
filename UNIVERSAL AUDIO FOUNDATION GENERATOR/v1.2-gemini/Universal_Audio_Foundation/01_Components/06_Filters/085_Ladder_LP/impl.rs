...
impl AudioNode for Ladder_LPNode {
...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = Ladder_LPNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "Ladder_LP");
    ...
    fn test_determinism() {
        ...
        let mut node = Ladder_LPNode::new();
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = Ladder_LPNode::new();
