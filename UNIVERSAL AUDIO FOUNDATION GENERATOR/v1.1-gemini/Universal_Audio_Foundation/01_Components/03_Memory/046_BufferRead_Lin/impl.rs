...
pub struct BufferRead_LinNode {
    // TODO: Add internal state here
}

impl BufferRead_LinNode {
    pub fn new() -> Self {
        Self {}
    }
}

impl AudioNode for BufferRead_LinNode {
...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = BufferRead_LinNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "BufferRead_Lin");
    ...
    fn test_determinism() {
        ...
        let mut node = BufferRead_LinNode::new();
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = BufferRead_LinNode::new();
