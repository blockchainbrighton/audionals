...
pub struct BufferRead_RawNode {
    // TODO: Add internal state here
}

impl BufferRead_RawNode {
    pub fn new() -> Self {
        Self {}
    }
}

impl AudioNode for BufferRead_RawNode {
...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = BufferRead_RawNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "BufferRead_Raw");
    ...
    fn test_determinism() {
        ...
        let mut node = BufferRead_RawNode::new();
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = BufferRead_RawNode::new();
