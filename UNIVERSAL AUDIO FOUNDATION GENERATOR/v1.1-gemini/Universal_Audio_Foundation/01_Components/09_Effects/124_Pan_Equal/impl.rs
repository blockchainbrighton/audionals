...
impl AudioNode for Pan_EqualNode {
...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = Pan_EqualNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "Pan_Equal");
    ...
    fn test_determinism() {
        ...
        let mut node = Pan_EqualNode::new();
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = Pan_EqualNode::new();
