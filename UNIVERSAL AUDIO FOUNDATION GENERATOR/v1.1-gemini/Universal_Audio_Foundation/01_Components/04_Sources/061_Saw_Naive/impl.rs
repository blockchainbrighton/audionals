...
impl AudioNode for Saw_NaiveNode {
...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = Saw_NaiveNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "Saw_Naive");
    ...
    fn test_determinism() {
        ...
        let mut node = Saw_NaiveNode::new();
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = Saw_NaiveNode::new();
