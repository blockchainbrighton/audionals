...
impl AudioNode for Tri_NaiveNode {
...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = Tri_NaiveNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "Tri_Naive");
    ...
    fn test_determinism() {
        ...
        let mut node = Tri_NaiveNode::new();
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = Tri_NaiveNode::new();
