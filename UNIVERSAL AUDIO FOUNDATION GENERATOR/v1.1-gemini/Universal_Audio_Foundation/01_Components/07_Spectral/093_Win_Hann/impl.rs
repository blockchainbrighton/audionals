...
impl AudioNode for Win_HannNode {
...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = Win_HannNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "Win_Hann");
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = Win_HannNode::new();
