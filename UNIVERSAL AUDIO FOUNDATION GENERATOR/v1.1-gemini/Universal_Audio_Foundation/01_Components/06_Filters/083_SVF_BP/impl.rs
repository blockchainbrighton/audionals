...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = SVF_BPNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "SVF_BP");
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = SVF_BPNode::new();
