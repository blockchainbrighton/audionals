...
mod tests {
    ...
    fn test_instantiation_and_metadata() {
        let node = SVF_HPNode::new();
        let meta = node.metadata();
        assert_eq!(meta.name, "SVF_HP");
    ...
    fn test_reset_behavior() {
        ...
        let mut clean_node = SVF_HPNode::new();
