...
class UIController {
  ...
  buildPresetPanel() {
    ...
    panel.innerHTML = '';
    const presetSelect = this.controlElement({ label: 'Factory Preset', type: 'select', options: this.synth.presetManager.list(), id: 'preset-select', tooltip: this.tip('preset.factory') });
