...
export class Arpeggiator {
    constructor(synthController) {
        ...
        this.randomNotesButton.addEventListener('click', this.randomizeNotes.bind(this));
...
handleArpeggiatorToggle() {
    console.log('Arpeggiator: ARP button clicked.');
    ...
    if (this.arpActive) {
        ...
        console.log('Arpeggiator: Arpeggiator activated and Tone.Transport started.');
    } else {
        Tone.Transport.stop();
        ...
        if (this.arpRepeatId !== null) {
            Tone.Transport.clear(this.arpRepeatId);
            this.arpRepeatId = null;
            console.log('Arpeggiator: Arpeggiator deactivated and Tone.Transport stopped.');
        }
    }
}
