...
- `src/app/initApp.js`: composes features and installs `window.showPage`.

### Project Layout (cv4.2)
- `docs/`: architecture + streamlining plan (`docs/ARCHITECTURE.md`, `docs/REFACTOR_PLAN.md`).
- `scripts/`: helper scripts (moved from root).
- `src/features/*`: split by feature with UI/storage/workflow modules.
