...
Instructions for working in this directory tree (`v4-codex/cv4.1`).
...
- `src/features/auth/authFeature.js`: Stacks Connect auth + diagnostics.
- `src/features/mint/mintFeature.js`: File selection, mint/resume pipeline, mint UI rendering.
- `src/features/viewer/viewerFeature.js`: Universal viewer + gallery + manifest playback.
