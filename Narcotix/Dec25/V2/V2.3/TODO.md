...
*   **Code Architecture:**
    ...
    *   [ ] TypeScript migration: As the codebase grows, static typing would prevent many runtime errors (like the recent missing property issues).
...
*   **HUD Enhancements:**
    ...
    *   [ ] Add a "Mini-map" or "Radar" module (could be a pill effect!).
    *   [ ] Floating combat text (damage numbers popping off enemies).
...
*   **Sound Engine:**
    *   [ ] Implement a `SoundManager` for handling BGM and SFX.
