// ContentLoader.js
 ...
 const preloadUrls = [
  ...
  "https://ordinals.com/content/1bda678460ef08fb64435b57c9b69fd78fd4556822ccd8e9839b4eb71b3621edi0"
];

// Create a map from OB1 numbers to URLs
const ob1UrlMap = preloadUrls.reduce((map, url, index) => {
  const ob1Number = `#${index + 1}`; // OB1 numbers start from 1
  map[ob1Number] = url;
  return map;
}, {});

console.log(ob1UrlMap);
