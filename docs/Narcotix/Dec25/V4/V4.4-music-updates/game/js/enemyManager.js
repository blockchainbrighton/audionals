...
export const enemyManager = {
    ...
    createEnemy: function(typeId, x, y, patrolPath=[]) {
        ...
        const enemyInstance = {
            ...
            facingX: 0, facingY: 1, // Default facing down
            ...
            takeDamage: function(amt) {
                ...
                // Play Hit Sound
                if (this.game.soundManager) this.game.soundManager.playHit();
            ...
            moveTo: function(tx,ty,dt){
                ...
                const mx=this.facingX*this.speed*dt, my=this.facingY*this.speed*dt;
