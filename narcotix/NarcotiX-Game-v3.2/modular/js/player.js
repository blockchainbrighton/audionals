...
export class Player {
    ...
    move(dx, dy, map, deltaSeconds = 0.016) {
        ...
        const travelDistance = this.speed * terrainSpeed * effectMultiplier * frameScalar;
        
        let moved = false;
        if (dirX !== 0) {
            const candidateX = this.x + dirX * travelDistance;
        ...
        if (dirY !== 0) {
            const candidateY = this.y + dirY * travelDistance;
