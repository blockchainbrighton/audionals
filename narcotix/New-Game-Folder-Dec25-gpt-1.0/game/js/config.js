...
export const MAP_WIDTH_TILES = 100;
export const MAP_HEIGHT_TILES = 100;
...
export const SAFEHOUSE_TILE = { x: 30, y: 31 };

export const PLAYER_SAFE_RADIUS_TILES = 8;
export const PLAYER_GRACE_PERIOD_MS = 8000;
