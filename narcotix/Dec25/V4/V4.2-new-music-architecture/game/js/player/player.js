...
export const player = {
    ...
    // --- Gang Logic ---
    joinExpressionGang: function(expressionSymbol) {
        ...
        if (gangData) {
            ...
            // Apply Max HP Mod immediately (Health scaling)
            // If HP Mod > 1, heal the difference? Or just raise cap? 
            // Let's raise cap and heal proportional amount.
