...
*   **World Building & Interaction:**
    *   [x] **Building Interiors:** Exchange nodes, Xemist contacts, bar/armoury/casino, and the safehouse use physical rooms with door transitions and entry modals.
    *   [ ] **Doors:** Add locked/key-required states or gating (basic door transitions implemented).
...
*   **Metadata Integration (Traits):**
    ...
    *   [x] **Expression Gangs:** Extended expression CSV powers gang joins, HUD status, stat mods, and on-kill perks.
...
*   **Visuals & Interface:**
    ...
    *   [x] **Item Imagery:** Inventory, stash, and shop lists show SVG/NFT imagery with Hiro/IPFS fallbacks.
...
*   **Asset Management:**
    *   [x] Image loader caches NFT art with Hiro/IPFS fallback.
    *   [ ] Implement unified `AssetLoader` to pre-load/cache local sprites and audio.
...
*   **Sound Architecture:**
    ...
    *   [x] **Location Soundtracks:** Location-aware themes for safehouse, shop, bar, casino, armoury, and overworld.
