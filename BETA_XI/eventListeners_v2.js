    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      const setupSequenceNav = (buttonId, offset) => {
        ...
        btn.addEventListener('click', () => {
          ...
          const totalSequences = Object.keys(window.unifiedSequencerSettings.settings.masterSettings.projectSequences).length;
          ...
          console.log(`[master] [${buttonId}] Transitioning to sequence ${targetSequence}`);
          ...
          console.log(`[master] [${buttonId}] Sending message to slave: ${JSON.stringify(message)}`);
          if (slaveWindow) {
