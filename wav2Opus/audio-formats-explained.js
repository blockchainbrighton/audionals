...
const audioFormatInfo = {
    ...
    // --- Core Concepts ---
    conceptsTitle: `<h2>Core Concepts: Containers, Codecs, Lossless vs. Lossy & Bitrate</h2>`, // Added comma <--- HERE
    ...
    formatsTitle: `<h2>Format Details & The Conversion Process</h2>`, // Added comma <--- HERE
    ...
    // Using the corrected WebM section from previous response
    webm: `
    ...
    // REVISED OPUS SECTION - FOCUS ON ENCODER ROLE
    opus: `
    ...
    opusRecommendationsTitle: `<h2>Opus Bitrate Recommendations (for WebM Output Quality vs. Size)</h2>`, // Added comma <--- HERE
