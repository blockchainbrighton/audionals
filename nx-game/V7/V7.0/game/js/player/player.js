...
export const player = {
    ...
    gang: null, // Store current Expression Cluster
    ...
    init: function(gameInstance) {
        ...
        this.equipWeaponById('unarmed'); 
        
        this.gang = null; // Reset cluster on init
