...
export const weaponsData = {
    ...
    'arc_rifle': {
        id: 'arc_rifle', name: "Arc Rifle", type: weaponTypes.RANGED, damage: 15, rangeMultiplier: 8.0, attackSpeed: 600,
        projectileType: 'arc_bolt', ammoCapacity: 8, currentAmmo: 8,
        char: '⚡', description: "Fires electrical bolts that chain to nearby targets.", color: '#0FF', projectileColor: '#0FF', accuracyCone: 0.1,
        damageType: 'energy'
    },
    'glitch_grenade': {
        id: 'glitch_grenade', name: "Glitch Grenade", type: weaponTypes.RANGED, damage: 30, rangeMultiplier: 6.0, attackSpeed: 1500,
        projectileType: 'grenade_glitch', ammoCapacity: 3, currentAmmo: 3,
        char: '💣', description: "Explodes on impact, stunning machinery.", color: '#F0F', projectileColor: '#F0F', accuracyCone: 0.5,
        damageType: 'glitch'
    }
};
...
export const ammoItemIds = {
    ...
    'arc_bolt': 'ammo_energy_cell',
    'grenade_glitch': 'ammo_glitch_charge'
};
