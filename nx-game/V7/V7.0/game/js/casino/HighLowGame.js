            ...
            <div class="casino-layout highlow-theme">
                ...
                <div class="bet-controls centered">
                    ...
                    <div class="bet-buttons">
                        <button class="button button-small" onclick="game.casino.HighLow.changeBet(10)">10</button>
                        <button class="button button-small" onclick="game.casino.HighLow.changeBet(50)">50</button>
                        <button class="button button-small" onclick="game.casino.HighLow.changeBet(100)">100</button>
                    </div>
                </div>
            </div>
        `;
