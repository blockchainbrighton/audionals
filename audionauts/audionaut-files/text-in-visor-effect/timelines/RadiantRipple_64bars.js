...
export function RadiantRipple_64bars() {
  return [
    { effect:"fade", param:"progress", from:0, to:1, startBar:0, endBar:32 },
    // { effect:"colourSweep", param:"mode", from:"reveal", to:"reveal", startBar:0, endBar:0 },
    { effect:"colourSweep", param:"brightnessRange", from:[0,70], to:[0,70], startBar:0, endBar:32 },
    { effect:"colourSweep", param:"progress", from:0, to:1, startBar:0, endBar:48 },
