...
(() => {
  ...
  class ScopeCanvas extends HTMLElement {
    constructor(){
      ...
      this.overlayRenderer = null; // Function to render overlays
    ...
    _animate(){
      ...
      // Render overlays (e.g., freestyle path recorder)
      if (typeof this.overlayRenderer === 'function') {
        this.overlayRenderer(this._ctx, this._canvas.width, this._canvas.height);
      }
